...
{
    public abstract class AyatGroupTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AyatGroupTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AyatGroupTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AyatGroupTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AyatGroupTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AyatGroupTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AyatGroupTestDbContext, Task<T>> func)
        {
            T result;
